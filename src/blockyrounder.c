...
static void setup_blocks() {
	twelve = GRect(59, 13, 24, 24);
	one = GRect(84, 24, 24, 24);
	two = GRect(105, 48, 24, 24);
	three = GRect(113, 72, 24, 24);
	four = GRect(105, 96, 24, 24);
	five = GRect(84, 120, 24, 24);
	six = GRect(59, 131, 24, 24);
	seven = GRect(34, 120, 24, 24);
	eight = GRect(13, 96, 24, 24);
	nine = GRect(5, 72, 24, 24);
	ten = GRect(12, 48, 24, 24);
	eleven = GRect(34, 24, 24, 24);
...
static void window_load(Window *window) {
	...
	//create the bitmaplayer to display the bluetooth gbitmap
...
static void init(void) {
	...
	//register for the bluetooth connections updates
#ifdef PBL_SDK_2
