...
function getAndStoreConfigData() {
	...
	localStorage.willdorfblockyrounderdegreeOption = options.degreeOption;
...
function loadOptions() {
	...
	if (localStorage.willdorfblockyrounderbackgroundColor) {
		...
		degreeOption = localStorage.willdorfblockyrounderdegreeOption;
		if (degreeOption == 0) {
